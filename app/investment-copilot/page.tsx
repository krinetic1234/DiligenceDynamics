...
export default function Page() {
  ...
  const fetchFiles = async () => {
    try {
      const companyRef = ref(storage, `companies/${companySymbol}/reports`);
  ...
  return (
    <Container fluid className="page-container">
      <Row>
        <Col>
          <h1 className="pt-5 pb-2">Investment Report Copilot</h1>
          <CompanyPicker
          ...
          {companySymbol && (
            <InvestmentCopilot companySymbol={companySymbol} mode={mode} onUploadSuccess={fetchFiles} />
          )}
